...
export default function ForgotPassword({ navigation }) {
  ...
  const handlePasswordReset = async () => {
    ...
    try {
      ...
      setErrorMessage("Te enviamos un correo para restablecer tu contraseña. Revisá tu bandeja de entrada o la carpeta de spam.");
...
// Reutiliza los estilos de Login, eliminando los que no se usan.
